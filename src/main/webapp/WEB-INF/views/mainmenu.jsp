...
<div class="wrap">
    <nav class="nav-bar navbar-inverse" role="navigation">
        <div id="top-menu" class="container-fluid active">
            <a class="navbar-brand" href="#">W. Autozone (pvt) Ltd. No 50, Main road, Wadduwa. Sri Lanka</a>
    ...
    <aside id="side-menu" class="aside" role="navigation">
        <ul class="nav nav-list accordion">
            <li class="nav-header">
                <div class="link"><i class="fa fa-lg fa-globe"></i>Menu<i class="fa fa-chevron-down"></i></div>
                <ul class="submenu">
                    <li><a href="#" onclick="cuspage()">Customer</a></li>
                    <li><a href="#">Repair Details</a></li>
                    <li><a href="#">Vehicle Data</a></li>
    ...
    <div class="content">
        ...
        <section class="content-inner" id="side_pages">
            <h2>Sample</h2>
